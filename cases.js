...
const CASES = [
  {
    title: "视觉系作品集小程序（摄影工作室 · 杂志风）",
    desc:  "摄影工作室作品集：首页作品卡堆可拖拽滑动、杂志式作品详情(编号衬线大字+长图文+点赞收藏)、风格类别横滑、微信登录、工作室名片(地图/电话/加微信二维码)、扫码页。暗调人像/亮调婚纱两套主题一份配置切换，全程可点。",
    tags:  ["小程序", "摄影/作品集", "视觉动效", "可定制"],
    path:  "cases/photo-studio/preview/index.html?c=sanjing",
    date:  "2026-07",
  },
  {
    title: "代扔垃圾 / 上门清运小程序（五享扔式）",
    desc:  "上门代扔生活垃圾 / 大件家具清运：单次代扔(选类型/袋数/楼层电梯/时段，实时算价)→微信手机号登录→下单；还能买包月套餐、下大件代扔、领超值券包、看订单。两套场景(生活垃圾代扔/大件装修清运)一份配置切换，全程可点。",
    tags:  ["小程序", "代扔/回收", "上门服务", "可定制"],
    path:  "cases/junk-pickup/preview/index.html?c=trash",
    date:  "2026-06",
  },
  {
