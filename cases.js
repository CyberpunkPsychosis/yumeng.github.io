...
const CASES = [
  {
    title: "校园宿舍即时零售三端（用户/骑手/后台）",
    desc:  "宿舍闪购平台：用户端利润引擎(凑单宝+阶梯换购免配送费)、骑手端运力体系(排班+GPS派单+水印照片+楼层阶梯佣金+忠诚度)、管理后台AI决策(经营报表+战区看板+未触达派券+语音库存)。算账正确，全程可点。",
    tags:  ["即时零售", "三端", "AI决策", "可定制"],
    path:  "cases/campus-delivery/index.html",
    date:  "2026-06",
  },
  {
    title: "视频课平台（网易云课堂式）",
    desc:  "在线视频课网站：分类浏览→课程详情(大纲/讲师/评价/购买)→学习页(视频播放器+章节目录+笔记+讨论问答)→学完领证书。一份配置换整套课程，全程可点。",
    tags:  ["教育", "视频课", "网页", "可定制"],
    path:  "cases/video-course/index.html",
    date:  "2026-06",
  },
  {
    title: "健身 App（Keep 式 · 完整版）",
    desc:  "成年向健身App：发现/课程/社区/我的四大Tab，运动分类、训练计划、全屏跟练播放器(小人动画+倒计时+语音口令)、社区打卡点赞、个人运动日历与勋章。一份配置换课程。",
    tags:  ["健身", "课程", "可玩", "可定制"],
    path:  "cases/fitness-app/index.html",
    date:  "2026-06",
  },
  {
    title: "儿童互动课程（数学启蒙 · 接 AI 老师）",
    desc:  "给5岁娃的互动课，像Keep那样闯关上课：数数/比多少/加减法，语音读题+答对音效。做错有AI小老师(接通义千问)讲解，对错本地判分保证准确。电脑网页+可打包单机App。",
    tags:  ["教育", "儿童", "AI", "可定制"],
    path:  "cases/kids-course/index.html",
    date:  "2026-06",
  },
  {
    title: "经纪人工作台（房产中介后台）",
    desc:  "中介B端SaaS：房源管理+录入/批量录入/【消息解析自动录入】、客源跟进与房客匹配、业绩统计与榜单、签约发起、地图找房、聊天。粘贴群消息自动拆成房源。",
    tags:  ["管理后台", "房产", "CRM", "可定制"],
    path:  "cases/realty-agent/index.html",
    date:  "2026-06",
  },
  {
